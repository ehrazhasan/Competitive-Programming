...
int main(){
    ...
    while(t--){
     	...
     	if(nonZero[0] != nonZero[nonZero.size() - 1]){
  ...
  //    	vector<ll> nonZero, zero;

  //    	for(int i = 0; i < n; i++){

  //    		if(b[i] == 0){

  //    			zero.push_back(diff[i]);
  //    		}
  //    		else{
  ...
  //    	if(zero.size() == 0 or nonZero.size() == 0){

  //    		cout << "YES\n";
  //    	}
  //    	else{

  //    		if(zero[zero.size() - 1] <= nonZero[0]) cout << "YES\n";
  //    		else cout << "NO\n";
  //    	}
