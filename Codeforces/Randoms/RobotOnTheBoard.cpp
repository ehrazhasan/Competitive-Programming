...
int main(){
    ...
    while(t--){
        ...
        pair<int,int> xRange = {1,n};
        pair<int,int> yRange = {1,m};
        ...
        for(auto it : s){
            ...
            xRange = intersection(xRange,x1);
            yRange = intersection(yRange,y1);

            if(xRange.first > xRange.second or yRange.first > yRange.second) break;
