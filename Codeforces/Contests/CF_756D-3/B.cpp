...
int main(){
    ...
    while(t--){
        ...
        // ans1 = min(athrees, bones);
        // ll rem1 = a - ans1*3;
        // ll rem2 = b - ans1;
        // if(rem1 == 2 and rem2 >= 6){

       	// 	ans1 += 2;
       	// }
       	// else if(rem1 == 2 and rem2 < 6){
        ...
        // ans3 = min(aones, bthrees);
        // rem1 = a - ans3;
        // rem2 = b - ans3*3;
       	
       	// if(rem2 == 2 and rem1 >= 6){

       	// 	ans3 += 2;
       	// }
       	// else if(rem2 == 2 and rem1 < 6){
