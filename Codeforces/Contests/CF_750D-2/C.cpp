...
int main(){
    ...
    while(t--){
        ...
        if(r < l){
         ...
         //removing s[l], ch1
        int left = l;
        for(int right = r; right >= 0 and right >= l;){
        	...
        	if(s[right] != ch1 and s[l] != ch1 and right != l){
        ...
        int ans2 = 0;
        //removing s[r], ch2
        for(int right = r; right >= 0 and right >= left;){
        	...
        	if(s[right] != ch2 and s[left] != ch2 and right != left){
        ...
        //db2(ans,ans2);
       	if(ans == INT_MAX and ans2 == INT_MAX){
