        ...
        for(int len = 3; len <= 4; len++){
        	...
        	for(int i = 0; i + len - 1 < n; i++){
        		...
        		if(len == 3){
        			...
        			if(!((v[i] <= v[i + 1] and v[i + 1] <= v[i + 2]) or (v[i] >= v[i + 1] and v[i + 1] >= v[i + 2])
						or (v[i] <= v[i + 1] and v[i + 1] <= v[i + 3]) or (v[i] >= v[i + 1] and v[i + 1] >= v[i + 3])
						or (v[i] <= v[i + 2] and v[i + 2] <= v[i + 3]) or (v[i] >= v[i + 2] and v[i + 2] >= v[i + 3])
						or (v[i + 1] <= v[i + 2] and v[i + 2] <= v[i + 3]) or (v[i + 1] >= v[i + 2] and v[i + 2] >= v[i + 3]))){
