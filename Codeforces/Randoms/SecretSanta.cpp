...
/*
    ...
    We have to have a valid assignment b,
    such that all bis are distinct and
    bi != i


    let say i can fulfill x wishes
    then I can definitely fulfill x - 1 wishes  

    Binary search?

    Can I fulfill x wishes?

    if distinct elements are >= x, then yes
    ...
    Maximum wish that can be fulfilled is total number of distinct elements, d
