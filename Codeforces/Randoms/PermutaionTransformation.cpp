 ...
 */                    
 ...
 void dfs(int pos, vector<int> &l, vector<int> &r,int step, vector<int> &v){
 	...
 	if(l[pos] != -1){
 		...
 		m[v[l[pos]]] = step;
 		dfs(l[pos],l,r,step + 1, v);
 	}

 	if(r[pos] != -1){

 		m[v[r[pos]]] = step;
 		dfs(r[pos],l,r,step + 1, v);
 	}
 }
 int main(){
     ...
     while(t--){
         ...
         int maxEl = max_element(all(v)) - v.begin();

         m.clear();

         m[v[maxEl]] = 0;

         dfs(maxEl,left,right,1,v);
