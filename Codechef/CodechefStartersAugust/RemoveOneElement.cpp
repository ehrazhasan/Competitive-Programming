...
int main(){
    ...
    while(t--){
        ...
        if(n == 2){
       	...
       	ll x  = b[0] - a[0] > 0 ? b[0] - a[0] : 1e12;
       	ll y = b[0] - a[1] > 0 ? b[0] - a[1] : 1e12;

       	db2(x,y);
       	ll z = b[n-2] - a[n-2] > 0 ? b[n-2] - a[n-2] : 1e12;
       	ll p = b[n-2] - a[n-1] > 0 ? b[n-2] - a[n-1] : 1e12;

        db2(z,p);
      	
      	ll ans1 = 1e12, ans2 = 1e12, ans3 = 1e12;
