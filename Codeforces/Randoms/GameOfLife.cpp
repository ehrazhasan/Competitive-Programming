    ...
    while(t--){
        ...
        for(int j = 0; j < min(m,n) ; j++){
        	...
        	for(int i = 0; i < n; i++){
        		...
        		if(i == 0 and i + 1 < n and st[i] == '0' and st[i + 1] == '1'){
        			s[i] = '1';
        		}
				else if(i == n - 1 and i - 1 >= 0 and st[i] == '0' and st[i - 1] == '1'){

        			s[i] = '1';
        		}
        		else if(st[i] == '0' and st[i - 1] == '1' and st[i + 1] == '0'){

        			s[i] = '1';
        		}
        		else if(st[i] == '0' and st[i - 1] == '0' and st[i + 1] == '1'){
