...
ll operation(string x, string y, char f){
	...
	for(int i = 0; i < n; i++){
		...
		if(x[i] == '1' and y[i] == '0') _10++;
		if(x[i] == '0' and y[i] == '1') _01++;
	}
...
int main(){
    ...
    while(t--){
        ...
        ll type01 = 0, type10 = 0, type11 = 0;
        for(int i = 0; i < n; i++){

        	if(s[i] == '0' and p[i] == '1') type01++;
        	if(s[i] == '1' and p[i] == '0') type10++;
    	...
    	string y = p;
    	// doing 1 1 operation
    	ans = min(ans, 1 + operation(x,y,'1'));
    	// doing 1 0 operation
    	ans = min(ans, 1 + operation(x,y,'0'));
