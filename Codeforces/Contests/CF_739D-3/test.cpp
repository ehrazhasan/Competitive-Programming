...
int main(){
    ...
    vector<vector<int> > prices{{74,7,80},{7,52,61},{62,41,37},{91,58,26},{88,98,5},{72,93,23},{56,58,94},{88,8,64},{32,55,5}};
  

    cout << t.maxHeight(prices) << endl;
    //cout << endl << gcd(360,8400);
