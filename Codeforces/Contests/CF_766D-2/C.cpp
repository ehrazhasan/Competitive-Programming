    ...
    while(t--){
       ...
       // cout << endl;
        ...
        while(!q.empty()){
        	...
        	if(indegree[x1] == 2 and !vis[x1]){ 
        		q.push(x1);
        		vis[x1] = true;
        	}
        	if(indegree[x2] == 2 and !vis[x2]){
    			q.push(x2);
    			vis[x2] = true;
        	}
        	...
        	if(!mp[{u1,x1}] and !mp[{u2,x2}]){

        		mp[{u1,x1}] = 2;
        		mp[{u2,x2}] = 3;
        	}

        	else if(!mp[{u1,x1}] and mp[{u2,x2}]){

        		if(mp[{u2,x2}] == 2) mp[{u1,x1}] = 3;
        		else mp[{u1,x1}] = 2;
        	}
        	else if(mp[{u1,x1}] and !mp[{u2,x2}]){

        		if(mp[{u1,x1}] == 2) mp[{u2,x2}] = 3;
        		else mp[{u2,x2}] = 2;

        	}
        	else{

        		if(mp[{u1,x1}] == mp[{u2,x2}]){
