...
ll solve(ll n, ll x, ll y, ll c, ll red, ll blue){
	...
	if(c == 0){
		...
		op1 = solve(n - 1, x, y, c, red, blue);
		op2 = x * solve(n, x, y, c ^ 1, red, blue + x);
	}
	else{

		op1 = solve(n - 1, x, y, c ^ 1, red, blue);
		op2 = y * solve(n - 1, x, y, c, red, blue + y);
	}
