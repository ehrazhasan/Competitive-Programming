...
vector<ll> fact = {87178291200, 6227020800, 479001600, 39916800, 3628800, 362880, 40320, 5040, 720, 120, 24, 6, 2, 1};
    ...
    while(t--){
        ...
        for(int mask = 0; mask < (1 << 14); mask++){
            ...
            if(sum <= n){
                ...
                ll val = total_set_bits(n - sum) + cnt;
                ans = min(ans,val);
            }
