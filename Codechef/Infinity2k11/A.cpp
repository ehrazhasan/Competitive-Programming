        		...
        		if(s[j] == '?'){
        			...
        			if(p[j] == '?'){
        				...
        				if(p[j] == ch){
        					...
        					if(vowel.find(p[j]) != -1 and vowel.find(ch) == -1){

        						cnt += 1;
        					}
        					else if(vowel.find(ch) != -1 and vowel.find(p[j]) == -1){
        			...
        			if(p[j] == '?'){
        				...
        				if(ch == s[j]){
        					...
        					if(vowel.find(s[j]) != -1 and vowel.find(ch) == -1){

        						cnt += 1;
        					}
        					else if(vowel.find(ch) != -1 and vowel.find(s[j]) == -1){
        				...
        				if(vowel.find(s[j]) != -1 and vowel.find(p[j]) == -1){

        						cnt += 1;
    					}
    					else if(vowel.find(p[j]) != -1 and vowel.find(s[j]) == -1){
