        	...
        	//db2(firstOne, lastOne);
      		if(firstOne == lastOne){
      			...
      			if(firstOne == 0) {
      				...
      				if(n - lastOne - 1 <= k) cout << 1 << endl;
      				else if(firstOne <= k) cout << 10 << endl;
      				else cout << ans << endl;
      			}
