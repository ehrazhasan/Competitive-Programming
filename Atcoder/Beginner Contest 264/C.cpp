...
int main(){
    ...
    while(t--){
        ...
        vector<vector<ll>> a(n1, vector<ll>(m1));
        rep(i, n1){
        ...
        vector<vector<ll>> b(n2, vector<ll>(m2));
        rep(i, n2){
        ...
        rep(i, n1){
            ...
            rep(j, m1){
                ...
                if(k < m2 and a[i][j] == b[0][k] and j > prev){
            ...
            rep(j , m1){
                ...
                if(a[r][j] == b[0][k]){
                    ...
                    repA(row, r, n1 - 1){
                        ...
                        if(rowb < n2 and a[row][j] == b[rowb][k]){
