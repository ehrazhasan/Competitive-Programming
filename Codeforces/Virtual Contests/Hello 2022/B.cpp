    ...
    while(t--){
		...
		pair<ll,ll> mini,maxi;
       	...
       	rep(i, n){
       		...
       		//db2(mini.first,maxi.first);
       		if(l < mini.first and r < maxi.first){

       			mini.first = l;
       			mini.second = c;
       			ans = mini.second + maxi.second;
       		}
       		else if(l < mini.first and r > maxi.first){
       			...
       			if(ans > c){
       				mini.second = c > mini.second ? mini.second : c;
       				maxi.second = c > maxi.second ? maxi.second : c;
       				ans = c;
       			}
       		}
       		else if(l == mini.first and r > maxi.first){
