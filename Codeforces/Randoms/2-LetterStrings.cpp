...
/*
    ...
    The number of pairs that differ in exactly one position is equal to the total number of pairs 
    - the pairs that differ in both positions + the pairs that are same
    ...
    total pairs possible n * (n - 1) / 2 = 4 * 3 = 12 / 2 = 6;
