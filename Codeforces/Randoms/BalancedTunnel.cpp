...
/*
	...
	A car that overtakes has to be fined

	If a car i comes later than car j and car i exits earlier than car j
	this means that car i overtook car j

	I need to find for a particular car what are the cars that came earlier to it
	and whether the same car exited earlier than it
