...
bool dfs(int i, int j, vector<vector<char>> &grid, bool dir){
    ...
    while(t--){
        ...
        repD(i, n - 1, 0){
        	...
        	repD(j, n - 1, 0){
        		...
        		bool down = dfs(i, j, grid, 0);
        		bool right = dfs(i, j, grid, 1);
