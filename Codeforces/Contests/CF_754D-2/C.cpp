...
int main(){
    ...
    while(t--){
     ...
     //     		sa = i;
     //     		if(a > b and a > c) ans = min(ans, sa - fa + 1);
     ...
     //    if(ans == INT_MAX) ans = -1;
       ...
       for(int i = 0; i + 2 < n; i++){
       		...
       		if(s.substr(i,3) == "aba" or s.substr(i,3) == "aca"){
       ...
       if(f) cout << 3 << endl;
       		...
       		for(int i = 0; i + 3 < n; i++){
	       		...
	       		if(s.substr(i,4) == "abca" or s.substr(i,4) == "acba"){
       		...
       		if(f) cout << 4 << endl;
                ...
                for(int i = 0; i + 6 < n; i++){
                    ...
                    if(s.substr(i,7) == "abbacca" or s.substr(i,7) == "accabba"){
